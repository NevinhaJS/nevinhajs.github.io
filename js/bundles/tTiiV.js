...
var tTiiV = function (_Component) {
  _inherits(tTiiV, _Component);

  function tTiiV() {
    _classCallCheck(this, tTiiV);

    return _possibleConstructorReturn(this, (tTiiV.__proto__ || Object.getPrototypeOf(tTiiV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tTiiV, _stickySoy2.default);

exports.default = tTiiV;
...
exports.templates = exports.tTiiV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tTiiV.
   * @public
   */

  goog.module('tTiiV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tTiiV.render';
  }
...
_metalSoy2.default.register(tTiiV, templates);
exports.tTiiV = tTiiV;
