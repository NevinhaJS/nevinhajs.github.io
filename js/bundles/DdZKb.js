...
var DdZKb = function (_Component) {
  _inherits(DdZKb, _Component);

  function DdZKb() {
    _classCallCheck(this, DdZKb);

    return _possibleConstructorReturn(this, (DdZKb.__proto__ || Object.getPrototypeOf(DdZKb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DdZKb, _indexSoy2.default);

exports.default = DdZKb;
...
exports.templates = exports.DdZKb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DdZKb.
   * @public
   */

  goog.module('DdZKb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DdZKb.render';
  }
...
_metalSoy2.default.register(DdZKb, templates);
exports.DdZKb = DdZKb;
