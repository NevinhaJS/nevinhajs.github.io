...
var xsTXk = function (_Component) {
  _inherits(xsTXk, _Component);

  function xsTXk() {
    _classCallCheck(this, xsTXk);

    return _possibleConstructorReturn(this, (xsTXk.__proto__ || Object.getPrototypeOf(xsTXk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xsTXk, _indexSoy2.default);

exports.default = xsTXk;
...
exports.templates = exports.xsTXk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xsTXk.
   * @public
   */

  goog.module('xsTXk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xsTXk.render';
  }
...
_metalSoy2.default.register(xsTXk, templates);
exports.xsTXk = xsTXk;
