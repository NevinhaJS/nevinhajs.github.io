...
var vmoll = function (_Component) {
  _inherits(vmoll, _Component);

  function vmoll() {
    _classCallCheck(this, vmoll);

    return _possibleConstructorReturn(this, (vmoll.__proto__ || Object.getPrototypeOf(vmoll)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vmoll, _motionsReferenceSoy2.default);

exports.default = vmoll;
...
exports.templates = exports.vmoll = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vmoll.
   * @public
   */

  goog.module('vmoll.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vmoll.render';
  }
...
_metalSoy2.default.register(vmoll, templates);
exports.vmoll = vmoll;
