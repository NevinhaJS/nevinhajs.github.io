...
var BglSY = function (_Component) {
  _inherits(BglSY, _Component);

  function BglSY() {
    _classCallCheck(this, BglSY);

    return _possibleConstructorReturn(this, (BglSY.__proto__ || Object.getPrototypeOf(BglSY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BglSY, _secondStepSoy2.default);

exports.default = BglSY;
...
exports.templates = exports.BglSY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BglSY.
   * @public
   */

  goog.module('BglSY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BglSY.render';
  }
...
_metalSoy2.default.register(BglSY, templates);
exports.BglSY = BglSY;
