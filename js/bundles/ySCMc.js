...
var ySCMc = function (_Component) {
  _inherits(ySCMc, _Component);

  function ySCMc() {
    _classCallCheck(this, ySCMc);

    return _possibleConstructorReturn(this, (ySCMc.__proto__ || Object.getPrototypeOf(ySCMc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ySCMc, _stickySoy2.default);

exports.default = ySCMc;
...
exports.templates = exports.ySCMc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ySCMc.
   * @public
   */

  goog.module('ySCMc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ySCMc.render';
  }
...
_metalSoy2.default.register(ySCMc, templates);
exports.ySCMc = ySCMc;
