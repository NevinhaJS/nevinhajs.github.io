...
var EqEtZ = function (_Component) {
  _inherits(EqEtZ, _Component);

  function EqEtZ() {
    _classCallCheck(this, EqEtZ);

    return _possibleConstructorReturn(this, (EqEtZ.__proto__ || Object.getPrototypeOf(EqEtZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EqEtZ, _indexSoy2.default);

exports.default = EqEtZ;
...
exports.templates = exports.EqEtZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EqEtZ.
   * @public
   */

  goog.module('EqEtZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EqEtZ.render';
  }
...
_metalSoy2.default.register(EqEtZ, templates);
exports.EqEtZ = EqEtZ;
