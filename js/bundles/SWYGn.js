...
var SWYGn = function (_Component) {
  _inherits(SWYGn, _Component);

  function SWYGn() {
    _classCallCheck(this, SWYGn);

    return _possibleConstructorReturn(this, (SWYGn.__proto__ || Object.getPrototypeOf(SWYGn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SWYGn, _indexSoy2.default);

exports.default = SWYGn;
...
exports.templates = exports.SWYGn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SWYGn.
   * @public
   */

  goog.module('SWYGn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SWYGn.render';
  }
...
_metalSoy2.default.register(SWYGn, templates);
exports.SWYGn = SWYGn;
