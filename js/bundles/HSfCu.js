...
var HSfCu = function (_Component) {
  _inherits(HSfCu, _Component);

  function HSfCu() {
    _classCallCheck(this, HSfCu);

    return _possibleConstructorReturn(this, (HSfCu.__proto__ || Object.getPrototypeOf(HSfCu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HSfCu, _indexSoy2.default);

exports.default = HSfCu;
...
exports.templates = exports.HSfCu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HSfCu.
   * @public
   */

  goog.module('HSfCu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HSfCu.render';
  }
...
_metalSoy2.default.register(HSfCu, templates);
exports.HSfCu = HSfCu;
