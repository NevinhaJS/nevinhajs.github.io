...
var PyMKU = function (_Component) {
  _inherits(PyMKU, _Component);

  function PyMKU() {
    _classCallCheck(this, PyMKU);

    return _possibleConstructorReturn(this, (PyMKU.__proto__ || Object.getPrototypeOf(PyMKU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PyMKU, _parallaxSoy2.default);

exports.default = PyMKU;
...
exports.templates = exports.PyMKU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PyMKU.
   * @public
   */

  goog.module('PyMKU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PyMKU.render';
  }
...
_metalSoy2.default.register(PyMKU, templates);
exports.PyMKU = PyMKU;
