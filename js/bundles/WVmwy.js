...
var WVmwy = function (_Component) {
  _inherits(WVmwy, _Component);

  function WVmwy() {
    _classCallCheck(this, WVmwy);

    return _possibleConstructorReturn(this, (WVmwy.__proto__ || Object.getPrototypeOf(WVmwy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WVmwy, _parallaxSoy2.default);

exports.default = WVmwy;
...
exports.templates = exports.WVmwy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WVmwy.
   * @public
   */

  goog.module('WVmwy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WVmwy.render';
  }
...
_metalSoy2.default.register(WVmwy, templates);
exports.WVmwy = WVmwy;
