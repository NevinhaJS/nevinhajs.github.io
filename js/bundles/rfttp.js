...
var rfttp = function (_Component) {
  _inherits(rfttp, _Component);

  function rfttp() {
    _classCallCheck(this, rfttp);

    return _possibleConstructorReturn(this, (rfttp.__proto__ || Object.getPrototypeOf(rfttp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rfttp, _indexSoy2.default);

exports.default = rfttp;
...
exports.templates = exports.rfttp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rfttp.
   * @public
   */

  goog.module('rfttp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rfttp.render';
  }
...
_metalSoy2.default.register(rfttp, templates);
exports.rfttp = rfttp;
