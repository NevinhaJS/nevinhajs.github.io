...
var xiEbL = function (_Component) {
  _inherits(xiEbL, _Component);

  function xiEbL() {
    _classCallCheck(this, xiEbL);

    return _possibleConstructorReturn(this, (xiEbL.__proto__ || Object.getPrototypeOf(xiEbL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xiEbL, _parallaxSoy2.default);

exports.default = xiEbL;
...
exports.templates = exports.xiEbL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xiEbL.
   * @public
   */

  goog.module('xiEbL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xiEbL.render';
  }
...
_metalSoy2.default.register(xiEbL, templates);
exports.xiEbL = xiEbL;
