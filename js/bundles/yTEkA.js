...
var yTEkA = function (_Component) {
  _inherits(yTEkA, _Component);

  function yTEkA() {
    _classCallCheck(this, yTEkA);

    return _possibleConstructorReturn(this, (yTEkA.__proto__ || Object.getPrototypeOf(yTEkA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yTEkA, _indexSoy2.default);

exports.default = yTEkA;
...
exports.templates = exports.yTEkA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yTEkA.
   * @public
   */

  goog.module('yTEkA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yTEkA.render';
  }
...
_metalSoy2.default.register(yTEkA, templates);
exports.yTEkA = yTEkA;
