...
var wJMnp = function (_Component) {
  _inherits(wJMnp, _Component);

  function wJMnp() {
    _classCallCheck(this, wJMnp);

    return _possibleConstructorReturn(this, (wJMnp.__proto__ || Object.getPrototypeOf(wJMnp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wJMnp, _firstStepSoy2.default);

exports.default = wJMnp;
...
exports.templates = exports.wJMnp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wJMnp.
   * @public
   */

  goog.module('wJMnp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wJMnp.render';
  }
...
_metalSoy2.default.register(wJMnp, templates);
exports.wJMnp = wJMnp;
