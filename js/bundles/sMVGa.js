...
var sMVGa = function (_Component) {
  _inherits(sMVGa, _Component);

  function sMVGa() {
    _classCallCheck(this, sMVGa);

    return _possibleConstructorReturn(this, (sMVGa.__proto__ || Object.getPrototypeOf(sMVGa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sMVGa, _indexSoy2.default);

exports.default = sMVGa;
...
exports.templates = exports.sMVGa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sMVGa.
   * @public
   */

  goog.module('sMVGa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sMVGa.render';
  }
...
_metalSoy2.default.register(sMVGa, templates);
exports.sMVGa = sMVGa;
