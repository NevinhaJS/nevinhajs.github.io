...
var OARuI = function (_Component) {
  _inherits(OARuI, _Component);

  function OARuI() {
    _classCallCheck(this, OARuI);

    return _possibleConstructorReturn(this, (OARuI.__proto__ || Object.getPrototypeOf(OARuI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OARuI, _parallaxSoy2.default);

exports.default = OARuI;
...
exports.templates = exports.OARuI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OARuI.
   * @public
   */

  goog.module('OARuI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OARuI.render';
  }
...
_metalSoy2.default.register(OARuI, templates);
exports.OARuI = OARuI;
