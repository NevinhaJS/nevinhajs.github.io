...
goog.loadModule(function (exports) {
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('A component render as React  that goes beyond of static methods and component lifecycles, including state, props,  improving the way you make meaningful animations and providing an amazing experience.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_open('br');
