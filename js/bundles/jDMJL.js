...
var jDMJL = function (_Component) {
  _inherits(jDMJL, _Component);

  function jDMJL() {
    _classCallCheck(this, jDMJL);

    return _possibleConstructorReturn(this, (jDMJL.__proto__ || Object.getPrototypeOf(jDMJL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jDMJL, _parallaxSoy2.default);

exports.default = jDMJL;
...
exports.templates = exports.jDMJL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jDMJL.
   * @public
   */

  goog.module('jDMJL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jDMJL.render';
  }
...
_metalSoy2.default.register(jDMJL, templates);
exports.jDMJL = jDMJL;
