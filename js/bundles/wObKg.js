...
var wObKg = function (_Component) {
  _inherits(wObKg, _Component);

  function wObKg() {
    _classCallCheck(this, wObKg);

    return _possibleConstructorReturn(this, (wObKg.__proto__ || Object.getPrototypeOf(wObKg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wObKg, _indexSoy2.default);

exports.default = wObKg;
...
exports.templates = exports.wObKg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wObKg.
   * @public
   */

  goog.module('wObKg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wObKg.render';
  }
...
_metalSoy2.default.register(wObKg, templates);
exports.wObKg = wObKg;
