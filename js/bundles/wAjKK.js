...
var wAjKK = function (_Component) {
  _inherits(wAjKK, _Component);

  function wAjKK() {
    _classCallCheck(this, wAjKK);

    return _possibleConstructorReturn(this, (wAjKK.__proto__ || Object.getPrototypeOf(wAjKK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wAjKK, _firstStepSoy2.default);

exports.default = wAjKK;
...
exports.templates = exports.wAjKK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wAjKK.
   * @public
   */

  goog.module('wAjKK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wAjKK.render';
  }
...
_metalSoy2.default.register(wAjKK, templates);
exports.wAjKK = wAjKK;
