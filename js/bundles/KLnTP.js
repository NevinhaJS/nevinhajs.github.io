...
var KLnTP = function (_Component) {
  _inherits(KLnTP, _Component);

  function KLnTP() {
    _classCallCheck(this, KLnTP);

    return _possibleConstructorReturn(this, (KLnTP.__proto__ || Object.getPrototypeOf(KLnTP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KLnTP, _firstStepSoy2.default);

exports.default = KLnTP;
...
exports.templates = exports.KLnTP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KLnTP.
   * @public
   */

  goog.module('KLnTP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KLnTP.render';
  }
...
_metalSoy2.default.register(KLnTP, templates);
exports.KLnTP = KLnTP;
