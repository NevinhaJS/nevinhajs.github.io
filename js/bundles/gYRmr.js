...
var gYRmr = function (_Component) {
  _inherits(gYRmr, _Component);

  function gYRmr() {
    _classCallCheck(this, gYRmr);

    return _possibleConstructorReturn(this, (gYRmr.__proto__ || Object.getPrototypeOf(gYRmr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gYRmr, _stickySoy2.default);

exports.default = gYRmr;
...
exports.templates = exports.gYRmr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gYRmr.
   * @public
   */

  goog.module('gYRmr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gYRmr.render';
  }
...
_metalSoy2.default.register(gYRmr, templates);
exports.gYRmr = gYRmr;
