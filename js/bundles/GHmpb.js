...
var GHmpb = function (_Component) {
  _inherits(GHmpb, _Component);

  function GHmpb() {
    _classCallCheck(this, GHmpb);

    return _possibleConstructorReturn(this, (GHmpb.__proto__ || Object.getPrototypeOf(GHmpb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GHmpb, _stickySoy2.default);

exports.default = GHmpb;
...
exports.templates = exports.GHmpb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GHmpb.
   * @public
   */

  goog.module('GHmpb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GHmpb.render';
  }
...
_metalSoy2.default.register(GHmpb, templates);
exports.GHmpb = GHmpb;
