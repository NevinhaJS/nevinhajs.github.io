...
var Form = function (_NevinhaComponent) {
	...
	_createClass(Form, [{
		...
		value: function render() {
			var handleKeyPress = this.props.handleKeyPress;


			return (0, _nevinhaJs.NevinhaDOM)(
				"div",
				{ ref: "teste", "class": "form" },
				(0, _nevinhaJs.NevinhaDOM)("input", {
					className: "input",
				...
				(0, _nevinhaJs.NevinhaDOM)(
					...
					(0, _nevinhaJs.NevinhaDOM)(
						"p",
						{ className: "footer", onClick: this.handleClick.bind(this) },
	...
	_createClass(App, [{
		...
		value: function render() {
			...
			return (0, _nevinhaJs.NevinhaDOM)(
				...
				(0, _nevinhaJs.NevinhaDOM)(
					"div",
					{ enterLeftBounce: true },
					(0, _nevinhaJs.NevinhaDOM)(
						"h1",
						{ className: "hello" },
						(0, _nevinhaJs.NevinhaDOM)(
							"p",
							{ className: "margin-hello" },
							"Hello! This is the new: "
						),
						name ? name : 'NevinhaJS'
					),
					(0, _nevinhaJs.NevinhaDOM)(Form, { handleKeyPress: this.handleKeyPress })
				)
			);
		}
	}]);
